 ...
 */
public class GoreGreavesItemGeckoLegacy extends Item implements GeoItem {
    private final AnimatableInstanceCache geoCache = GeckoLibUtil.createInstanceCache(this);

    public GoreGreavesItemGeckoLegacy(ArmorMaterial material, ArmorType type, Item.Properties properties) {
    ...
    public void createGeoRenderer(Consumer<GeoRenderProvider> consumer) {
        consumer.accept(new GeoRenderProvider() {
            private final Supplier<GeoArmorRenderer<?, ?>> renderer = Suppliers.memoize(() -> new GeoArmorRenderer<>(GoreGreavesItemGeckoLegacy.this));
